...
export default function Job() {
    ...
    useEffect(() => {
        const fetchJobs = async () => {
            try {
                ...
                const letJobs = data.filter(p => p.status === "Pending");
    ...
    return (
        <div className="">
            <h2 className="font-bold bg-[#4ea863] px-3 py-3 text-gray-200 rounded-t-lg">Pending Jobs: {total}</h2>
            <div className='p-6'>
                <h3 className="mb-6 text-gray-700">Recent Pending Jobs:</h3>
