...
export default function Sold() {
    ...
    useEffect(() => {
        const fetchJobs = async () => {
            try {
                ...
                const letJobs = data.filter(p => p.status === "Sell");
    ...
    return (
        <div className="">
            <h2 className="font-bold bg-[#1664c5] px-3 py-3 text-gray-200 rounded-t-lg">Sold Jobs: {total}</h2>
            <div className='p-6'>
                <h3 className="mb-6 text-gray-700">Recent Sold Jobs:</h3>
