...
export default function View({ open, onClose, viewData }) {
    const personalInfo = [
        { label: "Owner Name", value: viewData?.name },
    ...
    const businessInfo = [
        { label: "Business Name", value: viewData?.business_name },
        { label: "Business Address", value: viewData?.business_address },
            ...
            <Box sx={modalStyle}>
                ...
                {viewData ? (
                    <>
                        ...
                        <SectionCard icon={<WorkIcon color="warning" />} title="Business Info">
