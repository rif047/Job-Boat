...
export default function Agents() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const agents = response.data.filter(user => hasUserType(normalizeUserTypes(user.userType), 'Care Agent'));
        ...
        <Layout>
            ...
            <section className="flex justify-between px-1 md:px-4 py-2 bg-[#4ea863]">
                <div className="flex items-center">
                    <h1 className="font-bold text-sm md:text-lg text-white mr-2">Agent List</h1>
