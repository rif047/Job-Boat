        ...
        ...columns,
        {
            ...
            Cell: ({ row }) => (
                <div className="space-x-2">
                    {permissions.canView && (
                        <button className="actionBtn cursor-pointer px-2 py-0.5 rounded hover:shadow-2xl bg-slate-100 [&>svg]:w-[15px] hover:bg-slate-300" onClick={() => onView(row.original)} >
                            <VisibilityIcon />
                        </button>
                    )}
                    ...
                    {permissions.canDelete && (
                        <button className="actionBtn cursor-pointer px-2 py-0.5 rounded hover:shadow-2xl text-red-400 bg-red-50 [&>svg]:w-[15px] hover:bg-red-300" onClick={() => onDelete(row.original)} >
                            <DeleteIcon />
                        </button>
                    )}
                </div>
